...
import net.leaderos.auth.shared.model.request.RequestType;
...
public abstract class Request {
    ...
    public Request(String api, Map<String, String> body, @NotNull RequestType type) throws IOException {
        ...
        if (this.body != null) {
            ...
            try (OutputStreamWriter writer = new OutputStreamWriter(this.connection.getOutputStream(),
        ...
        try {
            ...
            Shared.getDebugAPI().send(responseString, false);
        } catch (Exception e) {
            Shared.getDebugAPI().send("URL: " + this.url, false);
