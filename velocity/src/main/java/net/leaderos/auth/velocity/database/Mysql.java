...
public class Mysql extends Database {
    ...
    public Mysql(Logger logger, boolean debug, String prefix,
            String hostname, int port, String database,
            String username, String password, String jdbcProperties) {
    ...
    public boolean initialize() {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://" + hostname + ":" + port + "/" + database + jdbcProperties);
        ...
        if (debug) {
            logger.info("JDBC URL: " + hikariConfig.getJdbcUrl());
        }
